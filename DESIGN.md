...
- Manual phone-use settlement is a small Today action below the primary Focus/Leisure pair. It opens the same Correction card review used by morning check-in, not a new destination.
