...
class FocusWellRepository internal constructor(
  ...
  private fun rulesToJson(rules: FocusWellRules): JSONObject {
    ...
    return JSONObject()
      ...
      .put("sleepProtectionEndHour", normalizedRules.sleepProtectionEndHour)
  ...
  private fun jsonToRules(json: JSONObject): FocusWellRules =
    FocusWellRules(
      ...
      dayBoundaryHour = json.optInt("dayBoundaryHour", 0),
      wakeTargetHour = json.optInt("wakeTargetHour", 5),
      sleepProtectionStartHour = json.optInt("sleepProtectionStartHour", 23),
      sleepProtectionEndHour = json.optInt("sleepProtectionEndHour", 7),
